...
def fetch_report_data(ref_number, line_number, selected_color_id):
    ...
    try:
        # Step 1: Get Job No and Company ID
        ...
        # Step 2: Get Job ID (Safer Parsing)
        ...
        # Step 3: Generate and Parse Final Report
        post_data = {
    ...
    for row in report_rows:
        ...
        if len(cells) >= 24:
            ...
            # --- NEW: Robust comparison by converting to integers ---
            try:
                # This line is changed to compare numbers instead of text
                ...
                # If the line number from the site is not a valid number, ignore and continue
                continue
